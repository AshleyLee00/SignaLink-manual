...
사용자는 슈퍼 관리자에 의해 CMS에 추가되며, 할당된 [사용자 유형](administration#사용자-유형)과 [사용자 그룹](groups)에서 적용된 [기능 및 공유](features-and-sharing)를 상속받아 CMS 내에서 접근 권한을 부여받습니다.
...
사전 구성된 **사용자 그룹** 중 하나를 선택하고 **온보딩 마법사**의 단계를 진행하거나 마지막 옵션인 **수동으로 사용자 생성**을 선택하여 [사용자 추가](administration#사용자-추가-양식) 양식으로 이동하세요.

### 온보딩 마법사

- [사용자 그룹](groups)을 선택하고 **다음**을 클릭하세요

  ::: tip
  [기능](features-and-sharing)은 이러한 그룹의 일반적인 기능에 대해 사전 구성되어 있습니다. 사용자 레코드를 편집하여 필요에 따라 추가로 수정할 수 있습니다!
  :::
...
- 새 사용자와 사용자 객체를 쉽게 공유할 [폴더](/tour/folders)를 선택하세요.
  ...
  ::: tip
  여러 사용자와 사용자 객체 공유를 간소화하기 위해 폴더 사용을 권장합니다. 폴더에 포함되거나 이동된 모든 항목은 사용자/사용자 그룹에 대해 활성화된 보기, 편집, 삭제 [공유](features-and-sharing#공유) 옵션을 상속받습니다.
  :::
...
::: warning
다른 사용자(예: 그룹 관리자 사용자)가 온보딩 마법사를 사용하여 사용자를 추가할 수 있도록 허용할 때, 사용자와 폴더를 보기 및 편집하기 위해 공유해야 하는 경우 [기능](/users/features-and-sharing)에서 **폴더**가 활성화되어 있는지 확인하세요!
:::
...
- 이 사용자가 라이브러리에 업로드할 수 있는 최대 [라이브러리 할당량](administration#라이브러리-할당량)을 입력하세요. 정보는 아래 섹션에서 찾을 수 있습니다.

- 이 사용자가 역할에 필요한 CMS의 관련 부분에 접근할 수 있도록 소속되어야 할 [사용자 그룹](groups)을 선택하세요.

  ::: tip
  CMS 내에서 아무것도 접근할 필요가 없지만 시스템 문제가 있을 때 시스템 관리자로서 알림 이메일을 받아야 하는 사용자의 경우 초기 사용자 그룹으로 **시스템 알림**을 사용하세요!
  :::

- 사용자의 '홈페이지'로 CMS의 관련 부분에만 접근을 허용하기 위해 [대시보드](dashboards) 선택에서 드롭다운을 사용하여 선택하세요. 사용자는 첫 로그인 후 이 대시보드로 이동합니다.
...
::: tip
이 메뉴에서 [사용자 그룹](groups) 멤버십, [홈 폴더](/tour/folders#홈-폴더) 및 [기능](features-and-sharing) 접근을 쉽게 관리할 수 있습니다.
